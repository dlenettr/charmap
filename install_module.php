...
$module = array(
	'name'	=> "MWS Char Map v1.3",
	'desc'	=> ( $config['langs'] == "Turkish" ) ? "Sitenizdeki makalelerin karakter haritasını oluşturun" : "Build character sitemap on your site",
	'id'	=> "charmap",
	'icon'	=> "charmap.png",
	'ticon'	=> "sitemap",
	'date'	=> "01.02.2018",
	...
	'image'	=> "https://img.dle.net.tr/mws/charmap.png",
...
if ( $is_logged && $member_id['user_group'] == "1" ) {
	...
	if ($_REQUEST['action'] == "install") {
		...
		$mod->file( ROOT_DIR. "/install/xml/charmap_102.xml" );
		$mod->close();
